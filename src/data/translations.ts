...
export interface Teacher {
  ...
  mobile: string;
  gender: 'male' | 'female';
  dob: string;          // Bengali formatted
  dobEn: string;        // English formatted
  jobStatus: string;    // e.g. কর্মরত
  firstJoinDate: string;      // Bn
  firstJoinDateEn: string;    // En
  schoolJoinDate: string;     // Bn
  schoolJoinDateEn: string;   // En
  profilePct: number;
  lastUpdated: string;  // Bn
  lastUpdatedEn: string; // En
}
...
export const translations = {
  bn: {
    ...
    contact: {
      ...
      addressTitle: "ঠিকানা",
      address: "গ্রাম: ঘাগড়া খিলমোগল, ডাকঘর: আলমশাহ পাড়া, উপজেলা: রাঙ্গুনিয়া, জেলা: চট্টগ্রাম",
      phoneTitle: "ফোন / মোবাইল",
      phone: "+880 1819-987654",
      emailTitle: "ইমেইল",
      email: "ghagrakhilmogalhakimuddin@gmail.com",
      hoursTitle: "স্কুল সময়সূচী",
      hours: "রবিবার - বৃহস্পতিবার: সকাল ৯:০০ - বিকাল ৪:০০",
...
export const teachersList: Teacher[] = [
  {
    ...
    designationBn: "ভারপ্রাপ্ত প্রধান শিক্ষক",
    designationEn: "Acting Head Teacher",
    qualificationBn: "সিএনএড",
    qualificationEn: "C.N.Ed",
    image: "/images/teachers/munmun_saha.jpg",
    pinNumber: "9141112030206",
    mobile: "01934189938",
    gender: "female",
    dob: "তথ্য পাওয়া যায়নি",
    dobEn: "Not available",
    jobStatus: "কর্মরত",
    firstJoinDate: "তথ্য পাওয়া যায়নি",
    firstJoinDateEn: "Not available",
    schoolJoinDate: "তথ্য পাওয়া যায়নি",
    schoolJoinDateEn: "Not available",
    profilePct: 100,
    lastUpdated: "তথ্য পাওয়া যায়নি",
    lastUpdatedEn: "Not available",
  },
  {
    id: "t2",
    nameBn: "নাছিমা আকতার",
    ...
    image: "/images/teachers/nasima_akter.jpg",
    pinNumber: "9141112040507",
    mobile: "01872051052",
    gender: "female",
    dob: "১৬ জুন, ১৯৮৭",
    dobEn: "16 June, 1987",
    jobStatus: "কর্মরত",
    firstJoinDate: "৬ সেপ্টেম্বর, ২০১২",
    firstJoinDateEn: "6 September, 2012",
    schoolJoinDate: "২৯ মার্চ, ২০১৫",
    schoolJoinDateEn: "29 March, 2015",
    profilePct: 98,
    lastUpdated: "৯ মার্চ, ২০২৪",
    lastUpdatedEn: "9 March, 2024",
  },
  {
    id: "t3",
    ...
    designationBn: "সহকারী শিক্ষক (সক্রিয়)",
    designationEn: "Assistant Teacher (Active)",
    qualificationBn: "এম.বি.এ, ডি.পি-ইন-এড",
    qualificationEn: "MBA, D.P-in-Ed",
    image: "/images/teachers/asraf_uddin.jpeg",
    pinNumber: "9141112111011",
    mobile: "01814354407",
    gender: "male",
    dob: "১ অক্টোবর, ১৯৮৯",
    dobEn: "1 October, 1989",
    jobStatus: "কর্মরত",
    firstJoinDate: "১৬ ফেব্রুয়ারি, ২০২০",
    firstJoinDateEn: "16 February, 2020",
    schoolJoinDate: "১৬ ফেব্রুয়ারি, ২০২০",
    schoolJoinDateEn: "16 February, 2020",
    profilePct: 100,
    lastUpdated: "৩০ জানুয়ারি, ২০২৬",
    lastUpdatedEn: "30 January, 2026",
  },
  {
    id: "t4",
    nameBn: "মুহাম্মদ সালাহউদ্দিন মাহমুদ",
    nameEn: "MUHAMMAD SALAHUDDIN MAHMUD",
    designationBn: "সহকারী শিক্ষক (সক্রিয়)",
    designationEn: "Assistant Teacher (Active)",
    qualificationBn: "এম.এস-সি, বি.এড",
    qualificationEn: "M.Sc, B.Ed",
    image: "/images/teachers/salahuddin.jpg",
    pinNumber: "9141112158323",
    mobile: "01820195550",
    gender: "male",
    dob: "১ মার্চ, ১৯৯১",
    dobEn: "1 March, 1991",
    ...
    firstJoinDate: "১৬ ফেব্রুয়ারি, ২০২০",
    firstJoinDateEn: "16 February, 2020",
    schoolJoinDate: "৮ এপ্রিল, ২০২৫",
    schoolJoinDateEn: "8 April, 2025",
    profilePct: 98,
    lastUpdated: "২৪ জুলাই, ২০২২",
    lastUpdatedEn: "24 July, 2022",
  },
  {
    id: "t5",
    nameBn: "শামীম আকতার",
    ...
    designationBn: "সহকারী শিক্ষক (সক্রিয়)",
    designationEn: "Assistant Teacher (Active)",
    qualificationBn: "বি.এ, ডিপইএড",
    qualificationEn: "B.A, Dp-in-Ed",
    image: "/images/teachers/shamim_akter.jpg",
    pinNumber: "9141112111012",
    mobile: "01868922793",
    gender: "female",
    dob: "১৫ নভেম্বর, ১৯৯২",
    dobEn: "15 November, 1992",
    jobStatus: "কর্মরত",
    firstJoinDate: "১৬ ফেব্রুয়ারি, ২০২০",
    firstJoinDateEn: "16 February, 2020",
    schoolJoinDate: "২২ জানুয়ারি, ২০২৩",
    schoolJoinDateEn: "22 January, 2023",
    profilePct: 100,
    lastUpdated: "২৫ জানুয়ারি, ২০২৬",
    lastUpdatedEn: "25 January, 2026",
  },
  {
    id: "t6",
    nameBn: "শোভন দে",
    ...
    designationBn: "সহকারী শিক্ষক (সক্রিয়)",
    designationEn: "Assistant Teacher (Active)",
    qualificationBn: "বি.এ, সি-ইন-এড",
    qualificationEn: "B.A, C-in-Ed",
    image: "/images/teachers/shobhan_dey.jpg",
    pinNumber: "9141112111093",
    mobile: "01832381121",
    gender: "male",
    dob: "৮ নভেম্বর, ১৯৯৪",
    dobEn: "8 November, 1994",
    jobStatus: "কর্মরত",
    firstJoinDate: "২২ জানুয়ারি, ২০২৩",
    firstJoinDateEn: "22 January, 2023",
    schoolJoinDate: "২৪ জানুয়ারি, ২০২৩",
    schoolJoinDateEn: "24 January, 2023",
    profilePct: 98,
    lastUpdated: "১৩ এপ্রিল, ২০২৬",
    lastUpdatedEn: "13 April, 2026",
  },
  {
    id: "t7",
    nameBn: "প্রিয়া দেব",
    ...
    designationBn: "সহকারী শিক্ষক (সক্রিয়)",
    designationEn: "Assistant Teacher (Active)",
    qualificationBn: "বি.এস-সি, ডি.পি.ই.ডি",
    qualificationEn: "B.Sc, D.P.Ed",
    ...
    dobEn: "12 July, 1996",
    jobStatus: "কর্মরত",
    firstJoinDate: "৬ মার্চ, ২০২৫",
    firstJoinDateEn: "6 March, 2025",
    schoolJoinDate: "৭ এপ্রিল, ২০২৫",
    schoolJoinDateEn: "7 April, 2025",
    profilePct: 98,
    lastUpdated: "২ জুন, ২০২৫",
    lastUpdatedEn: "2 June, 2025",
  },
];
